...
A commonly used distance metric for continuous variables is Euclidean distance. Suppose $$x$$ and $$y$$ are two points.

Euclidean distance: $$\sqrt{\sum_{i=1}^{n}(x_i - y_i)^2}$$

Manhattan distance: $$\sum_{i=1}^{n} \vert x_i - y_i \vert $$
