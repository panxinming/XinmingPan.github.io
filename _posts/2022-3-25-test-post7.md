...
Because we know **Logistic Regression** is a combination of **Linear Regression** and **Sigmoid Function**, so we can get our linear equation first.

In Linear Regression Post, I have discussed four ways to get our estimated parameters. Here, I used the easiest way which is Python. Python can automatically return us the slope and intercept.
